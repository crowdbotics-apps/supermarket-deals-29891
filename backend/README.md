...
## Project Structure
    ...
    ├── supermarket_deals_29891  # Django project configurations
...
1. Clone this repo and `cd supermarket_deals_29891`
...
2. Clone this repo and `cd supermarket_deals_29891`
